                  ...
                  <>
                    ...
                    {recentlyAddedItems && recentlyAddedItems.length > 0 && (
                      <div className="pt-4 flex-1 flex flex-col">
                        <div className="relative overflow-y-auto flex-1 min-h-[180px] max-h-[240px]">
                          <div 
                  ...
                  <>
                    ...
                    {runningServers.length > 0 ? (
                      <div className="space-y-2 flex-1 pt-4">
                        <div className="space-y-2 min-h-[240px] max-h-[265px] overflow-y-auto">
                      ...
                      <div className="flex-1 min-h-[240px] flex items-center justify-center text-center text-muted-foreground pt-4">
                        <div>
