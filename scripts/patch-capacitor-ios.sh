...
FILE="node_modules/@capacitor/ios/CapacitorCordova/CapacitorCordova/Classes/Public/CDVWebViewProcessPoolFactory.h"
if [ -f "$FILE" ] && ! grep -q "clang diagnostic" "$FILE"; then
  cat > "$FILE" << 'EOF'
/*
...
EOF
  echo "Patched CDVWebViewProcessPoolFactory.h"
fi
